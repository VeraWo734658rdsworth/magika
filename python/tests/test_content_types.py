...
def test_get_all_labels_contains_expected():
    ...
    # Added go since that's the primary language of this project
    for expected in ["python", "javascript", "json", "pdf", "png", "unknown", "shell", "markdown", "rust", "toml", "yaml", "dockerfile", "go"]:
